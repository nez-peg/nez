...
public abstract class ParserGrammarSourceGenerator extends Expression.Visitor implements SourceGenerator {
	...
	public ParserGrammarSourceGenerator() {
		this.file = null;
	}
	...
	@Deprecated
	protected ParserGrammarSourceGenerator inc() {
		file.incIndent();
		return this;
	}

	@Deprecated
	protected ParserGrammarSourceGenerator dec() {
		file.decIndent();
		return this;
	}
	...
	protected ParserGrammarSourceGenerator L(String line) {
		file.writeIndent(line);
		return this;
	}

	protected ParserGrammarSourceGenerator L() {
		file.writeIndent();
		return this;
	}

	protected ParserGrammarSourceGenerator W(String word) {
		file.write(word);
		return this;
	}

	protected ParserGrammarSourceGenerator Begin(String t) {
		W(t);
		file.incIndent();
		return this;
	}

	protected ParserGrammarSourceGenerator End(String t) {
		file.decIndent();
		if (t != null) {
			L(t);
		}
	...
	protected ParserGrammarSourceGenerator C(String name, Expression e) {
		int c = 0;
	...
	protected ParserGrammarSourceGenerator C(String name, String first, Expression e) {
		W(name);
		W(OpenClosure);
		W(first);
		W(ClosureDelim);
	...
	protected ParserGrammarSourceGenerator C(String name) {
		W(name);
		W(OpenClosure);
		W(CloseClosure);
		return this;
	...
	protected ParserGrammarSourceGenerator C(String name, String arg) {
	...
	protected ParserGrammarSourceGenerator C(String name, int arg) {
		W(name);
		W(OpenClosure);
	...
	protected ParserGrammarSourceGenerator C(String name, boolean[] arg) {
		int cnt = 0;
		W(name);
		W(OpenClosure);
