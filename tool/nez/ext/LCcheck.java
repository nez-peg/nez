...
//
//		if (totalCount > 1) {
//			Verbose.println(totalCount + " files, " + parsedCount + " parsed, " + formatCount + " formatted, " + matchCount + " matched, " + StringUtils.formatParcentage(matchCount, totalCount) + "% matched.");
//		}
