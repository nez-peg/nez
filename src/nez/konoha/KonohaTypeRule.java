...
// BFuncType funcType = this.newFuncType(gamma, sig.get(1), sig.get(2,null),
// nameMap);
...
// }
//
// private BFuncType newFuncType(SymbolTable gamma, PegObject paramNode,
// PegObject returnTypeNode, CommonMap<Integer> nameMap) {
// CommonArray<BType> typeList = new CommonArray<BType>(new
// BType[paramNode.size()+1]);
