...
public class InstructionSet {
	...
	public static String stringfy(byte opcode) {
		...
		case NByte: return "nbyte";
		case NAny:  return "nany";
		case NStr:  return "nstr";
		case NSet:  return "nset";

		case OByte: return "obyte";
		case OAny:  return "oany";
		case OStr:  return "ostr";
		case OSet:  return "oset";

		case RByte: return "rbyte";
		case RAny:  return "rany";
		...
		case MemoFail:   return "memofail";
		
		case TPush: return "tpush";
		case TPop:  return "tpop";
		case TLeftFold: return "tswap";
		case TNew:  return "tnew";
		case TCapture: return "tcap";
		case TTag:   return "ttag";
		case TReplace: return "trep";
		...
		case SMask:   return "mask";
		case SDef:    return "def";
		case SIsDef:  return "isdef";
		case SExists: return "exists";
		case SIs:     return "is";
		case SIsa:    return "isa";
		case SDefNum:    return "defnum";
		case SCount:  return "count";
