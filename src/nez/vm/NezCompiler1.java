...
public class NezCompiler1 extends NezCompiler {
	...
	public Instruction encodeMatchAny(AnyChar p, Instruction next) {
...
//	}
	...
	public Instruction encodeLink(Link p, Instruction next) {
