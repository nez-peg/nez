...
public abstract class AbstractTree<E extends AbstractTree<E>> extends AbstractList<E> {
	...
	public final String formatSourceMessage(String type, String msg) {
		return this.getSource().formatPositionLine(type,
				this.getSourcePosition(), msg);
	}
	...
	public final SourceContext newSourceContext() {
		return SourceContext.newStringSourceContext(this.getSource()
				.getResourceName(),
				this.getSource().linenum(this.getSourcePosition()), this
						.getText());
	}
	...
	public final String getText() {
		...
		if(this.source != null) {
			this.value = this.source.substring(this.getSourcePosition(),
					this.getSourcePosition() + this.length);
			return this.value.toString();
		}
		return "";
	}
