...
public class ScriptCompilerAsm extends TreeVisitor2<ScriptCompilerAsm.Undefined> implements CommonSymbols {
	...
	private void dispatch(TypedTree node) throws ClassNotFoundException {
		switch (node.hint) {
		case Constant:
