...
public class GrammarOption {
	...
	public final static GrammarOption newDefault() {
		return new GrammarOption();
	}

	public final static GrammarOption newSafe() {
		return new GrammarOption("-memo:-predict");
	}
	...
	public GrammarOption(String arguments) {
		this.setOption(arguments);
	}

	public GrammarOption clone() {
		GrammarOption o = new GrammarOption();
