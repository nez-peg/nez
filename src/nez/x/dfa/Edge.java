...
public class Edge {
	...
	public String toString() {
		return "( (" + src + "," + ((label != ' ') ? label : "epsilon") + "), " + dst + " \"" + ((predicate == 0) ? "&predicate" : ((predicate == 1) ? "!predicate" : "normal")) + "\")";
	}
...
class EdgeComparator implements Comparator {
	...
	public int compare(Object o1, Object o2) {
		...
		if (e1.getDst() != e2.getDst())
			return Integer.compare(e1.getDst(), e2.getDst());
		if (e1.getLabel() != e2.getLabel())
			return Character.compare(e1.getLabel(), e2.getLabel());
