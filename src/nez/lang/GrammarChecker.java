...
//
//	public GrammarChecker(GenerativeGrammar g, boolean offAST, TreeMap<String, Boolean> ctx, Production start, Strategy strategy, int i) {
//		this.gg = g;
...
//		ParseFunc f = gg.setParseFunc(uname, p, lp);
...
//			return gg.newNonTerminal(n.getSourcePosition(), uname);
//		}
...
//				return ExpressionCommons.newNewCapture(n.getSourcePosition(), gg.newNonTerminal(n.getSourcePosition(), uname));
//			}
//			this.requiredTypestate = Typestate.OperationType;
//			return gg.newNonTerminal(n.getSourcePosition(), uname);
//		}
...
//				return ExpressionCommons.newTlink(n.getSourcePosition(), null, gg.newNonTerminal(n.getSourcePosition(), uname));
//			}
