...
public class NezCombinator extends ParserCombinator {
	...
	public Expression Charset() {
		Expression _CharChunk = Sequence(New(P("CHAR"), Tag(NezTag.Class)), LeftFoldOption("right", t("-"), Link("left", New(P("CHAR"), Tag(NezTag.Class))), Tag(NezTag.List)));
		return Sequence(t("["), New(ZeroMore(Link(null, _CharChunk)), Tag(NezTag.Class)), t("]"));
	}

	public Expression Constructor() {
		return New(t("{"), Choice(Sequence(t("$"), Option(Link("name", "Name")), P("S"), Tag(NezTag.LeftNew)), Sequence(t("@"), P("S"), Tag(NezTag.LeftNew)), Tag(NezTag.New)), P("_"), Option(Link("expr", "Expr"), P("_")), t("}"));
	}
	...
	public Expression Func() {
		return Sequence(
				t("<"),
				New(Choice(Sequence(t("if"), P("S"), Link("name", "FlagName"), Tag(NezTag.If)),
						...
						// Sequence(t("x"), P("S"), Link("NonTerminal"), P("S"),
						// Link("NonTerminal"), P("S"), Link("Expr"), P("S"),
						// ZeroMore(t(","), P("S"), Link("NonTerminal"), P("S"),
						// Link("Expr"), P("S")),
						// t(">"), Tag(NezTag.Match)),
						...
						/* Deprecated */
						Sequence(t("with"), P("S"), Link("name", P("Name")), P("S"), Link("expr", "Expr"), Tag(NezTag.With)), Sequence(t("without"), P("S"), Link("name", P("Name")), P("S"), Link("expr", "Expr"), Tag(NezTag.Without)),
						Sequence(t("indent"), Tag(NezTag.Indent)), Sequence(OneMore(Not(">"), AnyChar()), Tag(NezTag.Undefined)))), P("_"), t(">"));
	}

	public Expression LabelLink() {
		return Sequence(t('$'), New(Option(Link("name", "Name")), t("("), P("_"), Link("expr", "Expr"), P("_"), t(")"), Tag(NezTag.Link)));
	}
	...
	public Expression Term() {
		...
		return Choice(P("SingleQuotedString"), P("Charset"), P("Func"), P("LabelLink"), _Any, P("ValueReplacement"), _Tagging, _Byte, _Unicode, Sequence(t("("), P("_"), P("Expr"), P("_"), t(")")), P("Constructor"), P("String"), P("NonTerminal"));
	}

	public Expression SuffixTerm() {
		return Sequence(P("Term"), LeftFoldOption("expr", Choice(Sequence(t("*"), Option(Link("times", P("Integer"))), Tag(NezTag.Repetition)), Sequence(t("+"), Tag(NezTag.Repetition1)), Sequence(t("?"), Tag(NezTag.Option)))));
	}

	public Expression Predicate() {
		return Choice(
				New(Choice(Sequence(t("&"), Tag(NezTag.And)), Sequence(t("!"), Tag(NezTag.Not)), Sequence(t("@["), P("_"), Link("index", P("Integer")), P("_"), t("]"), Tag(NezTag.Link)), Sequence(t("@"), Tag(NezTag.Link)),
						Sequence(t("~"), Tag(NezTag.Match))), Link("expr", P("SuffixTerm"))), P("SuffixTerm"));
	}
	...
	public Expression Sequence() {
		return Sequence(P("Predicate"), LeftFoldOption(null, OneMore(P("_"), P("NOTRULE"), Link(null, "Predicate")), Tag(NezTag.Sequence)));
	}

	public Expression Expr() {
		return Sequence(P("Sequence"), LeftFoldOption(null, OneMore(P("_"), t("/"), P("_"), Link(null, "Sequence")), Tag(NezTag.Choice)));
	}
	...
	public Expression Rule() {
		return New(P("addQualifers"), Link("name", Choice(P("NonTerminal"), P("String"))), P("_"), P("SKIP"), t("="), P("_"), Link("expr", "Expr"), Tag(NezTag.Rule));
	}
	...
	public Expression ImportName() {
		return New(Choice(t("*"), Sequence(P("NAME"), Option(t("."), Choice(t("*"), P("NAME"))))), Tag(NezTag.NonTerminal));
	}

	// import
	// import x.Xml
	public Expression Import() {
		return New(t("import"), P("S"), Link("name", "ImportName"), P("S"), t("from"), P("S"), Link("from", Choice(P("SingleQuotedString"), P("String"))), Tag(NezTag.Import));
	}
				...
				ZeroMore(
						...
						Link(null,
								Choice(Sequence(t("${"), P("Name"), t("}")),
										Sequence(t("$["), P("_"), P("Index"), P("_"), LeftFoldOption("left", t('`'), Link("format", "Formatter"), t('`'), P("_"), Link("right", "Index"), P("_"), Tag(NezTag.Format)), t("]")),
	...
	public Expression Format() {
		return New(t("format"), Tag(NezTag.Format), P("_"), t("#"), Link("name", "Name"), t("["), P("_"), Link("size", "FormatSize"), P("_"), t("]"), P("_"), t("`"), Link("format", "Formatter"), t("`"));
	}

	public Expression TemplateStatement() {
		return New(t("template"), OneMore(P("S")), Link("name", "Name"), P("_"), t("<"), P("_"), Link("param", "TemplateParameter"), t(">"), P("_"), t("="), P("_"), Link("expr", "Expr"), Tag(NezTag.Template));
	}

	public Expression TemplateParameter() {
		return New(Link(null, "Name"), P("_"), ZeroMore(t(","), P("_"), Link(null, "Name"), P("_")), Tag(NezTag.List));
	}

	public Expression Chunk() {
		return Sequence(P("_"), Choice(P("Example"), P("Import"), P("Format"), P("Rule")), P("_"), Option(t(";"), P("_")));
	}

	public Expression File() {
		return New(P("_"), ZeroMore(Link(null, "Chunk")), Tag(NezTag.Source));
	}
